...
#     """پردازش تصویر - ترتیب کاراکترها را اصلاح می‌کند"""
#     # تشخیص پلاک
...
#             "bbox": c['bbox'],
#             "position": "left_to_right"  # موقعیت فیزیکی در تصویر
#         })

#     # 🔑 ساخت متن نهایی:
#     # ترتیب فیزیکی در تصویر (چپ به راست): ['3','1','9','3','2','ص','6','5']
#     # پلاک فارسی راست به چپ خوانده می‌شود → معکوس می‌کنیم
#     physical_order = ''.join([c['mapped_char'] for c in filtered])  # '31932ص65'
#     persian_order = physical_order[::-1]  # '56ص23913'

#     return {
#         "status": "success",
#         "plate_text": persian_order,  # ✅ نمایش صحیح: '56ص23913'
#         "physical_order": physical_order,  # برای دیباگ: '31932ص65'
#         "confidence": round(plate_conf, 3),
#         "bbox": [x1, y1, x2, y2],
#         "characters": characters_array,  # آرایه کامل برای فرانت‌اند
